...
namespace DifferentWeb.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        {
            var subjects = db.Subjects.Include(s => s.Professor);
        ...
        public ActionResult Create([Bind(Include = "ID,SubjectName,SemestrID,BranchID,ProfessorID")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,SubjectName,SemestrID,BranchID,ProfessorID")] Subject subject)
        {
            if (ModelState.IsValid)
            {
