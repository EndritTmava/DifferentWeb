...
namespace DifferentWeb.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,DepartamentName")] Departament departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,DepartamentName")] Departament departament)
        {
            if (ModelState.IsValid)
            {
